...
export default function WonDeals() {
  ...
  const loadDeals = async () => {
    try {
      const data = await api.getArchivedWonDeals();
      setDeals(data || []);
    } catch (err) {
      ...
      <div className="archived-header">
        ...
        <div className="archived-stats">
          <div className="archived-stat">
            ...
            <span className="stat-value won-value">{formatCurrency(totalValue)}</span>
          </div>
          <div className="archived-stat">
          ...
          <tbody>
            {deals.map(deal => (
              <tr key={deal.id}>
                ...
                <td className="value-cell won-value">{formatCurrency(deal.deal_value)}</td>
